...
import { CharacterStats } from './types.js'; // Важно: в импортах мы всё равно пишем .js!
...
export class Character {
    ...
    constructor(name: string, savedData: CharacterStats | null = null) {
        this.name = name;
    ...
    removeExperience(points: number): void {
        this.xp -= points;
